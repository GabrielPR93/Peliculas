...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button Ocultar=findViewById(R.id.botonOcultar);
        final TextView textView=findViewById(R.id.textViewPrincipal);
        ...
        textView.setText(peliculas.get(0).getTitulo());
        ...
        View.OnClickListener listener=new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(miAdaptador.getSelectedPos()>=0){
                    textView.setText(peliculas.get(pos).getTitulo());
                }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.ListadoCompleto:
               Intent intentListadoCompleto=new Intent(MainActivity.this,TodasPelis.class);
               startActivity(intentListadoCompleto);
                return true;
            ...
            case R.id.añadir:
                Intent intentAñadir=new Intent(MainActivity.this,Anhadir.class);
